...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=1\linewidth]{diagrams/control-loop.pdf}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=1\linewidth]{diagrams/measurement.pdf}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.8\linewidth]{diagrams/demonstrator.pdf}
...
\begin{itemize}
    ...
    \item \textbf{Where can i find the source code?}
    On the GitHub page of the Institute of Flight Systems (DLR-FT): \cite{DLR_DynMultiCoreIntMit}
